...
const isTabletOrMobile = useMediaQuery({ query: '(max-width: 1224px)' })
  ...
  return (
    ...
    <div className='w-full p-4 flex flex-col gap-2 items-center'> 
      <Link to="/createtribute" state={{ userid: user?.rejistered?._id }} className='bg-blue-600 hover:bg-blue-800 p-2 w-[400px] text-white border-none text-center'>Create Tribute</Link> 
    {user?.rejistered?.tribute.map((tributes,index)=>{
         return(
