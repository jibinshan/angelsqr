      ...
      <div className='text-black'>
      {
        ...
        <div className=' w-full  flex flex-col items-center  pl-4 pr-4 gap-2'>
         <div className='p-[5px] rounded-[50%] bg-white absolute top-[100px]'>
          ...
          <h1 className='font-thin text-[#3b3b3b] text-[64px] mt-[100px]'>{user?.rejistered?.username}</h1>
          <p className='text-[26px] text-[#3b3b3b] text-center'>{user?.rejistered?.dateOfBirth} - {user?.rejistered?.dateOfDeath}</p>
          <p className='pb-2 text-center text-[26px] text-[#3b3b3b] font-thin'>{user?.rejistered?.about}</p>
          <div className='flex gap-4 '>
          <ul className='w-full grid grid-rows-2 grid-flow-col gap-4 '>
            <li onClick={()=>scrollhandler(bio)} className= ' cursor-pointer text-[18px] text-[#3b3b3b] font-[400] border-[1px] border-[#d1d1d1] p-2 rounded-xl flex flex-col justify-center items-center space-x-2 w-[134px] justify-center' ><img src={book} alt="" className='w-[40px] h-[40px]' /><span className='text-[18px] font-[400]' style={{fontFamily: 'Poppins, sans-serif'}}>Obituary</span></li>
            <li onClick={()=>scrollhandler(details)} className='cursor-pointer text-[18px] text-[#3b3b3b] font-[400] border-[1px] border-[#d1d1d1] p-2 rounded-xl flex flex-col justify-center items-center space-x-2 w-[134px] justify-center'   ><img src={candles} alt="" className='w-[40px] h-[40px]'/><span className='text-[18px] font-[400]' style={{fontFamily: 'Poppins, sans-serif'}}>Services</span></li>
            <li onClick={()=>scrollhandler(photos)} className='cursor-pointer text-[18px] text-[#3b3b3b] font-[400] border-[1px] border-[#d1d1d1] p-2 rounded-xl flex flex-col justify-center items-center space-x-2 w-[134px] justify-center'   ><img src={photoss} alt="" className='w-[40px] h-[40px]' /><span className='text-[18px] font-[400]' style={{fontFamily: 'Poppins, sans-serif'}}>Photos</span></li>
            ...
            <li onClick={()=>scrollhandler(tribute)} className='cursor-pointer text-[18px] text-[#3b3b3b] font-[400] border-[1px] border-[#d1d1d1] p-2 rounded-xl flex flex-col justify-center items-center space-x-2 w-[134px] justify-center'  ><img src={pen} alt="" className='w-[40px] h-[40px]' /><span className='text-[18px] font-[400]' style={{fontFamily: 'Poppins, sans-serif'}}>Memory Wall</span></li>
            </ul>
        </div>
        <div className='w-full pb-4 text-xl flex flex-col space-y-8 mb-[150px]'>
            <Bio bio={bio}/>
        ...
        <div className=' w-full  flex flex-col items-center  pl-4 pr-4 gap-[5px]'>
         <div className='p-[5px] rounded-[50%] bg-white absolute top-[100px]'>
          ...
          <h1 className='font-thin text-[#3b3b3b] text-[64px] mt-[70px]'>{user?.rejistered?.username}</h1>
           ...
           <p className='pb-4 text-center text-[26px] text-[#3b3b3b] font-thin'>{user?.rejistered?.about}</p>
